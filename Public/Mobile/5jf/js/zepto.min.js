var Zepto = function() {
	...
	return z.matches = function(a, b) {
		...
		prop: function(b, c) {
			return b = D[b] || b, c === a ? this[0] && this[0][b] : this.each(function(a) {
		...
		c.fn[a] = function() {
			...
			return e.length < 1 ? this : this.each(function(a, h) {
				f = d ? h : h.parentNode, h = 0 == b ? h.nextSibling : 1 == b ? h.firstChild : 2 == b ? h : null, e.forEach(function(a) {
...
function(a) {
	...
	a.active = 0, a.ajaxJSONP = function(d, e) {
		...
		if (n(c), c.crossDomain || (c.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(c.url) && RegExp.$2 != window.location.host), c.url || (c.url = window.location.toString()), w(c), c.cache === !1 && (c.url = v(c.url, "_=" + Date.now())), g = c.dataType, h = /\?.+=\?/.test(c.url), "jsonp" == g || h) return h || (c.url = v(c.url, c.jsonp ? c.jsonp + "=?" : c.jsonp === !1 ? "" : "callback=?")), a.ajaxJSONP(c, f);
...
function(a) {
	...
	a.fn.data = function(b, c) {
		...
		}) : 0 == this.length ? void 0 : g(this[0], b) : this.each(function() {
			h(this, b, c)
		})
...
function(a) {
	...
	a.fn.lazyload = function(c) {
		function f() {
			...
			h.each(function() {
				var c = a(this);
				if (!i.skip_invisible || "none" !== c.css("display"))
		...
		return c && (d !== c.failurelimit && (c.failure_limit = c.failurelimit, delete c.failurelimit), d !== c.effectspeed && (c.effect_speed = c.effectspeed, delete c.effectspeed), a.extend(i, c)), g = i.container === d || i.container === b ? e : a(i.container), 0 === i.event.indexOf("scroll") && g.on(i.event, function() {
			return f()
		}), this.each(function() {
			var b = this,
				c = a(b);
			b.loaded = !1, c.one("appear", function() {
				if (!this.loaded) {
					...
					a("<img />").on("load", function() {
						var d, e;
						c.hide().attr("src", c.data(i.data_attribute))[i.effect](i.effect_speed), b.loaded = !0, d = a.grep(h, function(a) {
							return !a.loaded
						}), h = a(d), i.load && (e = h.length, i.load.call(b, e, i))
					}).attr("src", c.data(i.data_attribute))
				}
			}), 0 !== i.event.indexOf("scroll") && c.on(i.event, function() {
				b.loaded || c.trigger("appear")
			})
		}), e.on("resize", function() {
			f()
		}), /iphone|ipod|ipad.*os 5/gi.test(navigator.appVersion) && e.on("pageshow", function(b) {
			b = b.originalEvent || b, b.persisted && h.each(function() {
