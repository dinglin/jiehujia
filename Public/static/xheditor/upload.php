...
define('ROOT_PATH', str_replace('Public/static/xheditor/upload.php', '', str_replace('\\', '/', __FILE__)));
$serverhost = 'http://'.$_SERVER['HTTP_HOST'];
$inputName='filedata';//表单文件域name
$attachDir=ROOT_PATH.'Uploads/img';//上传文件保存路径，结尾不要带/
	...
	if(preg_match('/^('.str_replace(',','|',$upExt).')$/i',$extension))
	{
		...
		else
		{
			...
			$targetPath=jsonString($targetPath);
                                                      $url = '/Uploads/img/'.$attachSubDir.'/'.$newFilename;
