(function(e, t) {
    ...
    var s = function() {
        ...
        i.fn = i.prototype = {constructor: i,init: function(e, r, s) {
                var o, u, f, l;
                if (!e) {
                    return this
                }
        ...
        i.extend = i.fn.extend = function() {
            var e, n, r, s, o, u, a = arguments[0] || {}, f = 1, l = arguments.length, c = false;
            if (typeof a === "boolean") {
                c = a;
                a = arguments[1] || {};
                f = 2
    ...
    s.support = function() {
        ...
        s(function() {
            ...
            if (e.getComputedStyle) {
                ...
                v.style.width = "2px";
                v.appendChild(c);
                t.reliableMarginRight = (parseInt((e.getComputedStyle(c, null) || {marginRight: 0}).marginRight, 10) || 0) === 0
            }
            ...
            f = {doesNotAddBorder: o.offsetTop !== 5,doesAddBorderForTableAndCells: a.offsetTop === 5};
            ...
            if (e.getComputedStyle) {
                v.style.marginTop = "1%";
                t.pixelMargin = (e.getComputedStyle(v, null) || {marginTop: 0}).marginTop !== "1%"
            }
    ...
    var f = /^(?:\{.*\}|\[.*\])$/, l = /([A-Z])/g;
    s.extend({cache: {},uuid: 0,expando: "jQuery" + (s.fn.jquery + Math.random()).replace(/\D/g, ""),noData: {embed: true,object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet: true},hasData: function(e) {
    ...
    s.extend({valHooks: {option: {get: function(e) {
                    ...
                    return n
                }}},attrFn: {val: true,css: true,html: true,text: true,data: true,width: true,height: true,offset: true},attr: function(e, n, r, i) {
    ...
    if (!E) {
        T = {name: true,id: true,coords: true};
        S = s.valHooks.button = {get: function(e, n) {
                var r;
    ...
    if (!s.support.style) {
        s.attrHooks.style = {get: function(e) {
    ...
    if (!s.support.optSelected) {
        s.propHooks.selected = s.extend(s.propHooks.selected, {get: function(e) {
                var t = e.parentNode;
                if (t) {
                    t.selectedIndex;
                    if (t.parentNode) {
    ...
    s.event = {add: function(e, n, r, i, o) {
            ...
            for (l = 0; l < n.length; l++) {
                ...
                y = s.event.special[h] || {};
                d = s.extend({type: h,origType: c[1],data: i,handler: r,guid: r.guid,selector: o,quick: o && _(o),namespace: p.join(".")}, v);
                g = f[h];
                if (!g) {
                    g = f[h] = [];
                    g.delegateCount = 0;
        ...
        },customEvent: {getData: true,setData: true,changeData: true},trigger: function(n, r, i, o) {
            ...
            if (i && !(n.button && n.type === "click")) {
                ...
                for (h = n.target; h != this; h = h.parentNode || this) {
                    if (h.disabled !== true) {
                        ...
                        if (g.length) {
                            f.push({elem: h,matches: g})
                        }
                    }
                }
            }
            if (r.length > i) {
                f.push({elem: this,matches: r.slice(i)})
            }
        ...
        },special: {ready: {setup: s.bindReady},load: {noBubble: true},focus: {delegateType: "focusin"},blur: {delegateType: "focusout"},beforeunload: {setup: function(e, t, n) {
                    if (s.isWindow(this)) {
            ...
            var i = s.extend(new s.Event, n, {type: e,isSimulated: true,originalEvent: {}});
            if (r) {
    ...
    s.each({mouseenter: "mouseover",mouseleave: "mouseout"}, function(e, t) {
    ...
    if (!s.support.submitBubbles) {
        s.event.special.submit = {setup: function() {
    ...
    if (!s.support.changeBubbles) {
        s.event.special.change = {setup: function() {
    ...
    (function() {
        ...
        var h = function(t, r, i, s) {
            ...
            var a, f, l, c, p, m, g, b, w = true, E = h.isXML(r), S = [], x = t;
            do {
                e.exec("");
                a = e.exec(x);
                if (a) {
            ...
            if (S.length > 1 && v.exec(t)) {
                ...
                if (r) {
                    p = s ? {expr: S.pop(),set: y(s)} : h.find(S.pop(), S.length === 1 && (S[0] === "~" || S[0] === "+") && r.parentNode ? r.parentNode : r, E);
        ...
        var d = h.selectors = {order: ["ID", "NAME", "TAG"],match: {ID: /#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS: /\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR: /\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG: /^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD: /:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO: /:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch: {},attrMap: {"class": "className","for": "htmlFor"},attrHandle: {href: function(e) {
        ...
        var v = d.match.POS, m = function(e, t) {
            return "\\" + (t - 0 + 1)
        };
        ...
        (function() {
            ...
            if (t) {
                var r = !t.call(n.createElement("div"), "div"), i = false;
                try {
    ...
    var j = /Until$/, F = /^(?:parents|prevUntil|prevAll)/, I = /,/, q = /^.[^:#\[\.,]*$/, R = Array.prototype.slice, U = s.expr.match.globalPOS, z = {children: true,contents: true,next: true,prev: true};
            ...
            if (s.isArray(e)) {
                ...
                while (o && o.ownerDocument && o !== t) {
                    for (r = 0; r < e.length; r++) {
                        if (s(o).is(e[r])) {
                            n.push({selector: e[r],elem: o,level: u})
                        }
                    }
                    o = o.parentNode;
                    u++
            ...
            if (this[0]) {
                ...
                if (l.length) {
                    s.each(l, function(e, t) {
                        if (t.src) {
                            s.ajax({type: "GET",global: false,url: t.src,async: false,dataType: "script"})
                        } else {
    ...
    s.extend({cssHooks: {opacity: {get: function(e, t) {
                ...
                }}},cssNumber: {fillOpacity: true,fontWeight: true,lineHeight: true,opacity: true,orphans: true,widows: true,zIndex: true,zoom: true},cssProps: {"float": s.support.cssFloat ? "cssFloat" : "styleFloat"},style: function(e, n, r, i) {
    ...
    if (!s.support.opacity) {
        s.cssHooks.opacity = {get: function(e, t) {
    ...
    s(function() {
        if (!s.support.reliableMarginRight) {
            s.cssHooks.marginRight = {get: function(e, t) {
    ...
    s.fn.extend({load: function(e, n, r) {
            ...
            var a = this;
            s.ajax({url: e,type: u,dataType: "html",data: n,complete: function(e, t, n) {
                    n = e.responseText;
                    if (e.isResolved()) {
                        e.done(function(e) {
                            n = e
    ...
    s.each(["get", "post"], function(e, n) {
        s[n] = function(e, r, i, o) {
            ...
            return s.ajax({type: n,url: e,data: r,success: i,dataType: o})
        }
    });
    ...
    s.fn.extend({show: function(e, t, n) {
            ...
            return this.each(function() {
                ...
                var t, n = false, i = s.timers, o = s._data(this);
                if (!r) {
                    s._unmark(true, this)
                }
                if (e == null) {
    ...
    s.fx.prototype = {update: function() {
            ...
            var t, n, r, i = gn || yn(), o = true, u = this.elem, a = this.options;
