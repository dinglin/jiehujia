...
class ClubController extends HomeController {
	...
	public function guide($id=""){
	    $tmpl = 'Club/guide';
	    $this->assign("PAGE_TITLE",'领队');
	    $this->tab_club = "guide";
	    
	    $club_id = session('main_club_id');
	    $this->guide = M("Club_user")->where(array("club_id"=>$club_id,"status"=>1))->getField("cuser_id,nick_name,logo");
	    $this->display($tmpl);
	}
